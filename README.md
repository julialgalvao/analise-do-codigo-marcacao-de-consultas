...
```bash
git clone https://github.com/julialgalvao/analise-do-codigo-marcacao-de-consultas.git
cd app-marcacao-de-consultas-es
```
...
Desenvolvido por Professor Hete Caetano e compartilhado com alunos